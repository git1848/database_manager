...
namespace DataBaseFront
{
    public class SDKSecurity
    {
        ...
        /// <returns></returns>
        public static string Base64Encrypt(string EncryptString, Encoding encoding)
        {
            return Convert.ToBase64String(encoding.GetBytes(EncryptString));
        }
        ...
        /// <param name="encoding">编码格式</param>
        /// <returns></returns>
        public static string Base64Decrypt(string DecryptString, Encoding encoding)
        {
